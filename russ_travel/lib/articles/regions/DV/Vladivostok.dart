...
class Vladivostok extends StatelessWidget {
  @override
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.done) {
              return Column(
                ...
                children: [
                  Image.network(
                    'https://sportishka.com/uploads/posts/2022-04/1650509259_1-sportishka-com-p-vladivostok-dostoprimechatelnosti-zolotoi-1.jpg',
                    height: 200,
                    fit: BoxFit.cover,
                  ),
                  Padding(
  ...
  Future<String> loadDescription() async {
    return await rootBundle.loadString('assets/DV/Vladivostok.txt');
  }
}
