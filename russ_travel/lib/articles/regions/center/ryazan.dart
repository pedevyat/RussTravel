...
class Ryazan extends StatelessWidget {
  @override
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.done) {
              return Column(
                ...
                children: [
                  Image.network(
                    'https://must-see.top/wp-content/uploads/2018/09/ryazanskij-kreml-768x513.jpg',
                    height: 200,
                    fit: BoxFit.cover,
                  ),
                  Padding(
  ...
  Future<String> loadDescription() async {
    return await rootBundle.loadString('assets/center/ryazan.txt');
  }
}