...
class Tambov extends StatelessWidget {
  @override
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.done) {
              return Column(
                ...
                children: [
                  Image.network(
                    'https://must-see.top/wp-content/uploads/2021/10/Usadba-Aseevyh-2048x1365.jpg',
                    height: 200,
                    fit: BoxFit.cover,
                  ),
                  Padding(
  ...
  Future<String> loadDescription() async {
    return await rootBundle.loadString('assets/center/tambov.txt');
  }
}