...
class Chyvashiya extends StatelessWidget {
  @override
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.done) {
              return Column(
                ...
                children: [
                  Image.network(
                    'https://mykaleidoscope.ru/x/uploads/posts/2022-09/1663200698_10-mykaleidoscope-ru-p-stolitsa-chuvashii-cheboksari-vkontakte-11.jpg',
                    height: 200,
                    fit: BoxFit.cover,
                  ),
                  Padding(
  ...
  Future<String> loadDescription() async {
    return await rootBundle.loadString('assets/privolzhye/chyvashiya.txt');
  }
}