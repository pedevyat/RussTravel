...
class Pskov extends StatelessWidget {
  @override
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.done) {
              return Column(
                ...
                children: [
                  Image.network(
                    'https://avatars.mds.yandex.net/get-entity_search/2340476/886032787/orig',
                    height: 200,
                    fit: BoxFit.cover,
                  ),
                  Padding(
  ...
  Future<String> loadDescription() async {
    return await rootBundle.loadString('assets/SZFO/Pskov.txt');
  }
}
