...
class Arhangelsk extends StatelessWidget {
  @override
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.done) {
              return Column(
                ...
                children: [
                  Image.network(
                    'https://gas-kvas.com/grafic/uploads/posts/2024-01/gas-kvas-com-p-oboi-goroda-arkhangelsk-2.jpg',
                    height: 200,
                    fit: BoxFit.cover,
                  ),
                  Padding(
  ...
  Future<String> loadDescription() async {
    return await rootBundle.loadString('assets/SZFO/Arhangelsk.txt');
  }
}
