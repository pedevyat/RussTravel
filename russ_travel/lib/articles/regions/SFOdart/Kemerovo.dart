...
class Kemerovo extends StatelessWidget {
  @override
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.done) {
              return Column(
                ...
                children: [
                  Image.network(
                    'https://mykaleidoscope.ru/x/uploads/posts/2022-09/1663343098_27-mykaleidoscope-ru-p-stolitsa-kemerovo-oboi-27.jpg',
                    height: 200,
                    fit: BoxFit.cover,
                  ),
                  Padding(
  ...
  Future<String> loadDescription() async {
    return await rootBundle.loadString('assets/SFO/Kemerovo.txt');
  }
}
