...
class Krasnoyarsk extends StatelessWidget {
  @override
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.done) {
              return Column(
                ...
                children: [
                  Image.network(
                    'https://sportishka.com/uploads/posts/2022-04/1650722160_2-sportishka-com-p-krasnoyarsk-krasivo-foto-2.jpg',
                    height: 200,
                    fit: BoxFit.cover,
                  ),
                  Padding(
  ...
  Future<String> loadDescription() async {
    return await rootBundle.loadString('assets/SFO/Krasnoyarsk.txt');
  }
}
